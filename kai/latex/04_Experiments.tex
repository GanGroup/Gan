...
\begin{table}[h!]
    ...
    \textbf{5} & 99.17 & 85.36 & \cellcolor{green!50} 55.21 & 65.54 \\ \hline
    \textbf{6} & 194.66 & 71.54 & 37.09 & \cellcolor{green!50} 35.78 \\ \hline
    \end{tabular}
    \vspace{2mm}
...
base on my assumption, I went back to check the code. I found have used 4 parameter in data augementation, rotation range, width shift range,
height shift range and horizontal flip.

Firstly, I remove the horizontal flip, the FID score is better then the model with data augementation but still worse than the score that I got from the model without data augmentaion.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \caption{Standard GAN with data augmentation but remove flip}
        \label{fig:Dense}
    \end{subfigure}
    \vspace{0.05\linewidth} 
    \begin{subfigure}[b]{\linewidth}
