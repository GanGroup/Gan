...
\noindent
2. \textbf{Rewriting the Objective Function}
...
\noindent
3. \textbf{Deriving the Optimal Discriminator}
...
\noindent
4. \textbf{Optimal Discriminator Formula}
...
\noindent
5. \textbf{Verifying the Optimal Discriminator}
...
The following is a result for a standard GAN model with high accuracy but generates low quality images.
